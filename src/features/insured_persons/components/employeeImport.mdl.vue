...
const importFile = () => {
  ...
  const successMessage =
    props.data === "drug" ? "Drug imported" : "Services imported";
...
const title =
  props.data === "dependant" ? "Import dependant Data" : "Import Employee Data";
</script>
  ...
  <div class="bg-black/50 min-h-full p-6 grid place-items-center">
    <ModalParent>
      ...
      >
          ...
          <div class="mb-4">
            ...
            >
              ...
              <template v-else>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-10 w-10 mx-auto text-green-500"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
        ...
        <template #bottom>
          <div
            class="flex gap-3 justify-between items-center w-full p-4 border-t"
          >
            <Button
