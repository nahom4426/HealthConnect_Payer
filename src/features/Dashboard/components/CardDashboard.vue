    ...
    <div class="flex justify-between w-full">
      <div class="flex flex-col gap-6 p-8">
        ...
        <p class="text-3xl font-semibold text-white">
          Exclusive Health Perks for Your Team with Nyala!
        </p>
        <p class="w-[816px] text-xl text-white/80">
          Unlock Exclusive Health Insurance Benefits for Your Team with Nyala
          Insurance! Discover a world of comprehensive coverage tailored
