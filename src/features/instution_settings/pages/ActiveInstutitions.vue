...
<ellipse cx="9.99992" cy="4.99999" rx="1.66667" ry="1.66667" stroke="#02676B" stroke-width="1.5"/>
 ...
 <p class="text-base">Filters</p>
    ...
    <!-- Add Button -->
    <template #add-action>
      <Button @click.prevent="handleAddInstitution" class="btn flex justify-center items-center text-center gap-2 rounded-lg h-14 px-8 bg-primary text-white hover:bg-primary-dark">
