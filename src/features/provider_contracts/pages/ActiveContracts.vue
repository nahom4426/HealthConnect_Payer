...
function handleContractUpdated(updatedContract: any) {
    ...
    <template #default="{ search }">
      ...
      >
        <Table
          :pending="pending"
          :headers="{
            head: ['Provider Name', 'Contract Type', 'Start Date', 'End Date', 'Status', 'Actions'],
            row: ['providerName', 'contractType', 'startDate', 'endDate', 'status']
          }"
          :rows="contracts"
          :rowCom="StatusRow"
          :pagination="{
        ...
        >
          ...
          <template #row>
            <StatusRow 
              :rowData="contracts" 
              :rowKeys="['providerName', 'contractType', 'startDate', 'endDate', 'status']" 
              :headKeys="['Provider Name', 'Contract Type', 'Start Date', 'End Date', 'Status', 'Actions']"
              :onView="viewDetails"
